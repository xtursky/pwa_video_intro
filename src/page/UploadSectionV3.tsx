...
function LiveStreamPreview({stream}) {
  ...
  return <video ref={videoPreviewRef}
                width={520}
                height={480}
                muted
                autoPlay
...
function UploadSectionV3() {
  ...
  return (
    <div>
      <p>
        <div>Option4: Use-media-recorder library utilizing MediaRecorder API providing react hook</div>
        ...
        {status === 'recording' ? <LiveStreamPreview stream={liveStream}/> : null}
        {status !== 'recording' ? (
            <>
